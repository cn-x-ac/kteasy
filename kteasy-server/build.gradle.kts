...
dependencies {
    ...
    // Maven Central 的 io.github.biezhi:TinyPinyin（Apache-2.0、类包名 com.github.promeg.pinyinhelper.Pinyin）；
    // 唯一 compile 传递依赖 org.ahocorasick:ahocorasick 亦 Apache-2.0，pinyin4j 仅 test scope 不入产物——满足 NOTICE「仅宽松许可」。
